...
function UserModel( caminio, mongoose ){
  ...
  var schema = new mongoose.Schema({
    ...
    salt: {type: String},
    apiPublicKey: { type: String, index: { unique: true, sparse: true }, public: true, default: function(){ return caminioUtil.uid(48); } },
    apiPrivateKey: { type: String, index: { unique: true, sparse: true }, public: true, default: function(){ return caminioUtil.uid(48); } },
