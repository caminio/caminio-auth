...
module.exports = function( caminio ){
  ...
  var ensureApiKey = require('./ensure_api_private_key')( caminio );
    
  return function ensureLoginOrApiPrivateOrToken(req, res, next) {
    ...
    if (!req.isAuthenticated || !req.isAuthenticated()) {
      ...
      if( 'authorization' in req.headers ){
        if( req.header('authorization').indexOf('API-PRIVATE-KEY') >= 0 )
